...
def grid_hilbert_order_from_circular(length, mask_radius, mask_centre):
    """
...
def image_and_grid_from_circular(image, mask, mask_radius, mask_centre, pixel_scales, hilbert_length):
    ...
    x1d_hb, y1d_hb = grid_hilbert_order_from_circular(
...
class HilbertAnnular(AbstractImageMeshWeighted):
    def __init__(
        self,
        pixels=10.0,
        weight_floor=0.0,
